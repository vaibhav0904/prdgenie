...
// him — the video is for "technical and non-technical audiences" and is not scored.
//
// So, this time:
...
export const SLIDES = [
  ...
  // ------------------------------------------------------------------------------------- 8
  {
    ...
    blocks: [
      ...
      { type: 'note', text: 'Built one story at a time: 105 stories done, 11 recorded decisions, and every defect found mid-story became its own card. 57 closed, 24 open and written down.' },
    ],
    command: {
