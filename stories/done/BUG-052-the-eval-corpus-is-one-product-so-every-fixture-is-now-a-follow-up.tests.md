...
| TC10 | **A full produce fills the manifest for all ten fixtures**, and the grader still grades it | 10 of 10 | **Pass** | `10/10 attempted fixtures reached storage`, 9 generated + G1 correctly parked `no_requirements_found` |
